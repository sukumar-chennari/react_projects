...
export const Modal = ({ closeModal, getData, saveData, currentUser }) => {
  ...
  const onSubmitHandler = (e) => {
    ...
    if (userData.index !== null) {
      saveData(userData); // Save updated data
    } else {
        ...
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">
              {userData.index !== null ? "Edit User" : "Add User"}
            </h5>
            <button
              type="button"
              className="btn-close"
